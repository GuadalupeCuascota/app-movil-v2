...
export class TestAptitudService {
  ...
  gettest(){
    ...
    test: testAptitud[]=[
      ...
      {
        pregunta:'Consideras que te resulta atractivo revisar cronogramas de producción.',
        carrera:'Industrial',
        opciones:[
          {
            opcion:'Si',
      ...
      {
        pregunta:'Creo que es importante realizar análisis y síntesis en el trabajo',
      ...
      {
        pregunta:'Tengo interés y curiosidad por los dispositivos eléctricos y electrónicos',
        carrera:'Electricidad',
        opciones:[
          {
            opcion:'Si',
      ...
      {
        pregunta:'Siento gran satisfacción cuando soy capaz de resolver los problemas.',
        carrera:'Mecatrónica',
        opciones:[
          {
      ...
      {
        pregunta:'Me gustaría encontrar un trabajo en el que pudiera ayudar a todas aquellas personas que lo necesitan.',
        carrera:'Automotriz',
        opciones:[
          {
            opcion:'No, prefiero trabajos en los que no me relacione con otras personas.',
            puntos:20,
            id_opcion: 1
          },
          {
      ...
      {
        pregunta:'Me gustaría participar en algún proyecto o trabajo de investigación',
        carrera:'Telecomunicaciones',
        opciones:[
          {
      ...
      {
        pregunta:'Creo que existen un gran número de teorías que no son verdaderas.',
        carrera:'Electricidad',
        opciones:[
          {
            opcion:'Si',
      ...
      {
        pregunta:'Me cuesta hacer dibujos de figuras para que se vean como en tres dimensiones.',
        carrera:'Industrial',
        opciones:[
          {
            opcion:'Si',
      ...
      {
        pregunta:'Me gusta realizar construcciones tridimensionales con piezas (como Lego, puzles 3D…)',
        carrera:'Automotriz',
        opciones:[
          {
            opcion:'Si',
      ...
      {
        pregunta:'Puedo hacer cálculos matemáticos mentalmente con bastante rapidez.',
        carrera:'Telecomunicaciones',
        opciones:[
          {
            opcion:'Si',
      ...
      {
        pregunta:'Creo que la matemática sirve para solucionar problemas teóricos y prácticos ',
        carrera:'Software',
        opciones:[
          {
            opcion:'Si',
      ...
      {
        pregunta:'Me relaciono de mejor manera a través de las redes sociales o plataformas en línea. ',
        carrera:'Software',
        opciones:[
          {
            opcion:'Si',
      ...
      {
        pregunta:'Tengo información sobre el procesamiento de fibras, hilados, tejidos y no tejidos.',
        carrera:'Textil',
        opciones:[
          {
            opcion:'Si',
      ...
      {
        pregunta:'Me resulta fácil hacer que los demás me escuchen y sigan mis planes, soy un poco líder.',
        carrera:'Industrial',
        opciones:[
          {
            opcion:'Si',
      ...
      {
        pregunta:'Siento interés por diagnosticar, reparar o reemplazar partes averiadas de cualquier vehículo. ',
        carrera:'Automotriz',
        opciones:[
          {
            opcion:'Si',
      ...
      {
        pregunta:'Suelo hacer muchas preguntas sobre el funcionamiento de las cosas.',
        carrera:'Mecatrónica',
        opciones:[
          {
            opcion:'Si',
